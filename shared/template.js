...
const renderPage = ({ cssRoot, navRoot, fileName, content, extraHead, extraBodyStart, showNav = true }) => `
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
    ...
    <body>
        ${extraBodyStart || ''}
        <article>
          ${showNav ? `<div class="nav"><h2><a href="${navRoot || cssRoot}">Farm Games</a>| ${fileNameToTitle(fileName)}</h2></div>` : ''}
          ${content}
        </article>
    </body>
</html>
